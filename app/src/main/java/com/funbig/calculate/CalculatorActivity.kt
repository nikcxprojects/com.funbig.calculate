...
import com.funbig.calculate.databinding.ActivityCalculatorBinding
...
class CalculatorActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onResume() {
        super.onResume()
        binding.bg.setBackgroundResource(getSharedPreferences("prefs", MODE_PRIVATE).getInt("bg",R.color.first))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageButton.setOnClickListener {
         if(binding.textViewInputNumbers.text.isNotEmpty())   binding.textViewInputNumbers.text =
                binding.textViewInputNumbers.text.subSequence(0,binding.textViewInputNumbers.text.length-1)
        }
